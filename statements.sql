...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL AND edad >25<35
...
-- Tu respuesta aquí
SELECT COUNT(lenguaje)  FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL GROUP BY nombre

-- Ejercicio 22: Encontrar el lenguaje con más caracteres.
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes  ORDER BY  LENGTH(lenguaje) DESC
...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE lenguaje LIKE 'J%' ORDER BY LENGTH(nombre) ASC LIMIT 1
...
-- Tu respuesta aquí
SELECT COUNT(*) FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL AND edad >25 AND edad <30

-- Ejercicio 33: Seleccionar los usuarios que no tienen un lenguaje asociado llamado 'SQL'.
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL AND lenguaje != 'SQL'

-- Ejercicio 34: Encontrar el lenguaje con más caracteres entre los usuarios que tienen al menos 30 años.
-- Tu respuesta aquí
SELECT lenguaje FROM usuarios_lenguajes WHERE edad >=29 ORDER BY lenguaje DESC LIMIT 1
